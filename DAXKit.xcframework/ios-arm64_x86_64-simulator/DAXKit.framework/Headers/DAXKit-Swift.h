...
///
/// \param outputFormIds Optional list of output form IDs for the session. If not set, no form IDs are sent.
///
///
/// returns:
...
- (DAXSession * _Nonnull)sessionWithIdentifier:(NSString * _Nonnull)identifier ehrData:(EHRData * _Nullable)ehrData workflow:(WorkflowSettings * _Nonnull)workflow reportLocale:(NSLocale * _Nullable)reportLocale uxLocale:(NSLocale * _Nullable)uxLocale outputFormIds:(NSArray<NSString *> * _Nullable)outputFormIds SWIFT_WARN_UNUSED_RESULT;
...
///
- (void)didCompleteSessionWithIdentifier:(NSString * _Nonnull)identifier SWIFT_DEPRECATED_MSG("Encounter complete workflow is no longer supported. This delegate method will no longer be called.");
...
///
- (void)didFailToCompleteSessionWithIdentifier:(NSString * _Nonnull)identifier withError:(NSError * _Nonnull)error SWIFT_DEPRECATED_MSG("Encounter complete workflow is no longer supported. This delegate method will no longer be called.");
...
///
/// \param outputFormIds Optional list of output form IDs for this recording. If set, overrides session-level outputFormIds. If nil, falls back to session-level outputFormIds.
///
///
/// throws:
...
- (Recorder * _Nullable)startRecordingWithDelegate:(id <RecordingDelegate> _Nonnull)delegate locales:(NSArray<NSLocale *> * _Nonnull)locales autoNoteGeneration:(BOOL)autoNoteGeneration outputFormIds:(NSArray<NSString *> * _Nullable)outputFormIds error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Completes the session
- (BOOL)completeAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_DEPRECATED_MSG("Encounter complete workflow is no longer supported. This method is now a no-op.");
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) BOOL deliverOnceOnSessionComplete SWIFT_DEPRECATED_MSG("Encounter complete workflow is no longer supported. This property will be ignored.");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDeliverOnceOnSessionComplete:(BOOL)deliverOnceOnSessionComplete OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Encounter complete workflow is no longer supported. Use init() instead.");
@end
